...
public class Servicios {
    ...
    public Servicios(String ID, String Nombre, String Descripcion, Double Precio, byte[] imagen, String Categoria, String tiempo, String Calificacion, String DescripcionC) {
        this.ID = ID;
        this.Nombre = Nombre;
