...
@WebServlet("/ComprarAlgoS")
public class ComprarAlgoSServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (servicio == null) {
            ...
            response.sendRedirect("../ComprarAlgoS.jsp?mensaje=Mascota no encontrada");
            return;
        }
        ...
        venta.setTotal(servicio.getPrecio()); // El total es igual al precio de la mascota en este caso
    ...
    if (ultimoIds != null && ultimoIds.startsWith("DVN")) {
        ...
        if (exito) {
            ...
            response.sendRedirect("../comprar/ComprarAlgoS.jsp?mensaje=Error al realizar la compra");
        }
    }
