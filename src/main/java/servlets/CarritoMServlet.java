...
@WebServlet("/CarritoM")
public class CarritoMServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Mascota servicio = mascotaDAO.obtenerPorId(idservicio);
        if (servicio == null) {
...
// Aquí puedes establecer otros atributos de la venta, como el método de pago o el total
    ...
    if (exito) {
        ...
        response.sendRedirect("/PasandoOW/comprar/ComprarAlgoM.jsp?mensaje=Error al añadir detalles");
    }
} else {
