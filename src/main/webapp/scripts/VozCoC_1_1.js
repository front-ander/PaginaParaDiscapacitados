document.addEventListener('keydown', (event) => {
    if (event.key.toLowerCase() === 'f') {
        ...
        function readProductInfo() {
            ...
            const tiempo = product.querySelector('.time').textContent;

            const message = `Asistente: ${nombre}. Descripción: ${descripcion}. ${calificacion}. ${tiempo}. ${precio}. ¿Te gustaría comprarlo? Si quieres pasar al siguiente, di 'siguiente'.`;
