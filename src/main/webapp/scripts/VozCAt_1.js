...
document.addEventListener('keydown', (event) => {
    if (event.key.toLowerCase() === 'f') {
        ...
        const emocionalLink = document.querySelector('a[href="Mascotas/Emocional.jsp"]');
        const guiaLink = document.querySelector('a[href="Mascotas/Guia.jsp"]');
        const señalLink = document.querySelector('a[href="Mascotas/Señal.jsp"]');
        const generalLink = document.querySelector('a[href="Mascotas/General.jsp"]');
        ...
        function askForProduct() {
            speakMessage("¿Qué estás buscando? Tenemos Guia , Emocional,  Señal y mascotas generales.", () => {
