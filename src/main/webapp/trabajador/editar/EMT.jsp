    ...
    <table>
        ...
        <tbody>
            <% 
                ...
                for (Mascota mascots : mac) { 
            %>
            <tr>
                <td><%= mascots.getID()%></td>
                <td><%= mascots.getNombre()%></td>
                <td><%= mascots.getDescripcion()%></td>
                <td><%= mascots.getPrecio()%></td>
                <td><%= mascots.getTiempo()%></td>
                <td><%= mascots.getCalificacion()%></td>
                <td><%= mascots.getCategoria() %></td>
                <td>
                        <img src="data:image/jpeg;base64,<%= mascots.getImagenBase64() %>" alt="Imagen de la cara" width="100" height="100"/>
                    </td>
                <td>
                    <form action="EEMT.jsp" method="post" style="display:inline;">
                        <input type="hidden" name="id" value="<%= mascots.getID() %>">
