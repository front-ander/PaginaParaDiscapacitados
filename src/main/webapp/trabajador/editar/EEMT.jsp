...
<%
        ...
        Mascota mact = mascotaDAO.obtenerPorId(id);
        CategoriaDAO categoriaDAO = new CategoriaDAO();
        List<Categoria> cates = categoriaDAO.obtenerCategoriasM();
 // Obtener el usuario
    %>
<!DOCTYPE html>
<html lang="es">
...
<body>
    ...
    <main>
        ...
        <div class="form-container">
            <form action="../../actualizarMascota" method="post" enctype="multipart/form-data">
